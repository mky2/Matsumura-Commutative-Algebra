...
\usepackage{xcolor}
\definecolor{mygreen}{HTML}{138952}
\definecolor{mypurple}{HTML}{521389}
\definecolor{myorange}{HTML}{895213}
\usepackage[bookmarks=true, colorlinks=true, linkcolor=mygreen, citecolor=mypurple, hypertexnames=false]{hyperref}
